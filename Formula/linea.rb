class Linea < Formula
  ...
  url "https://github.com/bniladridas/linea/archive/refs/tags/v0.3.7.tar.gz"
  sha256 "ee1f4b82e5e7abbd32dcfe26e67e165ec6d4ae1231ab88689fd05e23bc4bc85f"
  license "MIT"
  head "https://github.com/bniladridas/linea.git", branch: "main"

  bottle do
    root_url "https://github.com/bniladridas/linea/releases/download/v0.3.7"
    sha256 arm64_sequoia: "4cd8dc221f3a1fe2c259b8a81e74eeb16a92a64f924bba766087bcb33e2944cc"
  end
