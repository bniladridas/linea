class Linea < Formula
  ...
  url "https://github.com/bniladridas/linea/archive/refs/tags/v0.3.19.tar.gz"
  sha256 "f07627daffe3ada8313898263a1f139c181c63c10841aa069566a8d434dd8430"
  license "MIT"
  head "https://github.com/bniladridas/linea.git", branch: "main"

  bottle do
    root_url "https://github.com/bniladridas/linea/releases/download/v0.3.19"
    sha256 arm64_sequoia: "57e9eefca0164a8b12f06732376681bc775a74f4586baf744c5b6cda54f61964"
  end
